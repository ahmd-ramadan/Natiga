...
const CloseIcon = ({ className, size = "20px", color = "#808080", ...rest }: IProps) => {
    return (
        <button 
            className={`${className}`}
            { ...rest }
        >
            <svg width={size} height={size} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill={color} stroke={color}>
